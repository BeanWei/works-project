...
def get_pic_html():
    ...
    for index in range((division-1)/3):
        ...
        subtitle=type[11]
        if "Spk Rub" in title:
            line_pic=Line(title,subtitle,width=1900,height=900)
            for compare in range(files_number):
                ...
                line_pic.add(sn_info,x,y,is_smooth=True,is_legend_show=False,is_more_utils=True,yaxis_force_interval=1 )
            page.add(line_pic)
